...
function setTheme(mode) {
  ...
  themeIcon.innerHTML = mode === 'light'
    ? '<circle cx="12" cy="12" r="6" fill="#facc15"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M4.93 19.07l1.41-1.41M17.66 6.34l1.41-1.41" stroke="#facc15" stroke-width="2" fill="none"/>'
    : '<circle cx="12" cy="12" r="6" fill="#facc15"/><path d="M18 12a6 6 0 1 1-6-6" fill="#232946"/>';
}
themeBtn.onclick = () => {
